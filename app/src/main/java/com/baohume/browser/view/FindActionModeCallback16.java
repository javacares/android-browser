...
import com.baohume.browser.BrowserWebView;
...
public class FindActionModeCallback16 implements ActionMode.Callback, TextWatcher,
    ...
    public FindActionModeCallback16(Context context) {
    ...
    public void setWebView(BrowserWebView webView) {
        if (null == webView) {
            throw new AssertionError("WebView supplied to "
                    + "FindActionModeCallback16 cannot be null");
        }
        mWebView = webView;
//        mWebView.setFindDialogFindListener(this);
    ...
    private void findNext(boolean next) {
        if (mWebView == null) {
            throw new AssertionError(
                    "No WebView for FindActionModeCallback16::findNext");
        }
        if (!mMatchesFound) {
            findAll();
            return;
    ...
    public void findAll() {
        if (mWebView == null) {
            throw new AssertionError(
                    "No WebView for FindActionModeCallback16::findAll");
        }
...
//        mWebView.setFindDialogFindListener(null);
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
        if (mWebView == null) {
            throw new AssertionError(
                    "No WebView for FindActionModeCallback16::onActionItemClicked");
        }
        mInput.hideSoftInputFromWindow(mWebView.getWindowToken(), 0);
